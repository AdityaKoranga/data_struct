// Q6)    We have two queues, the input queue Q1 and the output queue Q2 and one stack S. We are only allowed to dequeue from Q1
// and enqueue into the output queue. We are allowed to both push into and pop from the stack.
