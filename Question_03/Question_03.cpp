// Q3)   Given a null terminated linked list, in, create a new null-terminated linked, list out, of the same length, such that node
// i of out contains the sum of the data in in's nodes up to and including node i of list in.
